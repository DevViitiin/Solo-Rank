...
class MissionService {
  ...
  Future<MissionToggleResult> toggleMission({
    ...
    try {
      ...
      final newTotalXp = (currentUser.totalXp + xpChange).clamp(0, 999999999);
      
      final oldLevel = currentUser.level;
      final oldRank = currentUser.rank;
      ...
      final newMissionCount = currentUser.stats.totalMissionsCompleted + 1;
      
      debugPrint('📊 Valores calculados:');
      debugPrint('   XP: ${currentUser.totalXp} → $newTotalXp (+$xpChange)');
  ...
  // =========================================================================
  // CÁLCULOS (mantém sua lógica original)
  // =========================================================================
